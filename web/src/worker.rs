...
use wordle_entropy_core::entropy::calculate_entropies2;
...
use wordle_entropy_core::to_seq::*;
use rayon::iter::*;
...
impl Worker for WordleWorker {
    ...
    fn handle_input(&mut self, msg: Self::Input, id: HandlerId) {
        let words = &msg;
        let answers = &msg;
        calculate_entropies2(&words, answers).into_par_iter().into_seq_iter().for_each(move |x| self.link.respond(id, x));
        /*
